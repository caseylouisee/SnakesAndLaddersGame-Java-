...
Constructor for the square if it already contains a value -\/ used for the load game function 
\begin{DoxyParams}{Parameters}
{\em i} & squares position on the board \\
\hline
{\em value} & X, O or \char`\"{} \char`\"{} \\
\hline
{\em display} & the display it is loaded onto \\
\hline
\end{DoxyParams}


Definition at line 39 of file Square\+T\+T\+T.\+java.
...
Definition at line 51 of file Square\+T\+T\+T.\+java.
